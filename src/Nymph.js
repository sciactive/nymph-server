...
export default class Nymph {
  static callStatic(name, args) {
    return Nymph.driver[name](...args);
  }
   ...
   * @return bool True on success, false on failure.
   */
  static function saveEntity(&$entity) {
   ...
   */
  static function formatSelectors(&$selectors) {
   ...
   * @return bool True on success, false on failure.
   */
  static function deleteEntityByID($guid) {
    return self::__callStatic(__FUNCTION__, func_get_args());
  }
  /**
   * Delete a unique ID.
   ...
   * @return bool True on success, false on failure.
   */
  static function deleteUID($name) {
    return self::__callStatic(__FUNCTION__, func_get_args());
  }
  /**
   ...
   * @return bool True on success, false on failure.
   */
  static function export($filename) {
    return self::__callStatic(__FUNCTION__, func_get_args());
  }
  /**
   ...
   */
  static function getEntities($options = [], ...$selectors) {
    return self::__callStatic(__FUNCTION__, func_get_args());
  }
  /**
   ...
   */
  static function getEntity($options = [], ...$selectors) {
    return self::__callStatic(__FUNCTION__, func_get_args());
  }
  /**
   ...
   * @return bool True on success, false on failure.
   */
  static function renameUID($oldName, $newName) {
    return self::__callStatic(__FUNCTION__, func_get_args());
  }
  /**
   ...
   * @return bool True on success, false on failure.
   */
  static function setUID($name, $value) {
    return self::__callStatic(__FUNCTION__, func_get_args());
  }
};

Nymph.VERSION = '3.0.0-beta.7';
/**
